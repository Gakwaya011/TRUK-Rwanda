...
import servicesHeroBg from '../assets/aboutPage.jpg'; 

const ServicesPage = () => {
  
  const servicesData = [
    {
      id: "transport", // MATCHES ServiceDetail Key
    ...
    {
      id: "storage", // MATCHES ServiceDetail Key
    ...
    {
      id: "farm-to-market", // MATCHES ServiceDetail Key
    ...
    {
      id: "cross-border", // MATCHES ServiceDetail Key
      ...
      <div className="relative w-full h-[50vh] min-h-[400px] flex flex-col">
        ...
        <div className="relative z-10 flex-grow flex flex-col items-center justify-center text-center px-4 pt-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <p className="text-[#FAD201] font-bold tracking-[0.2em] uppercase mb-4 text-sm md:text-base">What we do</p>
            <h1 className="text-5xl md:text-7xl font-black text-white uppercase tracking-tighter drop-shadow-2xl">Our Services</h1>
              ...
              <Link to={`/services/${service.id}`}>
                <div className="group relative h-[500px] w-full overflow-hidden rounded-[2rem] shadow-2xl cursor-pointer bg-gray-900">
                  ...
                  <div className="absolute inset-0 p-8 flex flex-col justify-end">
                    ...
                    <span className="text-[#FAD201] font-bold tracking-widest text-sm uppercase mb-2 translate-y-4 group-hover:translate-y-0 transition-transform duration-500">{service.category}</span>
                    <h3 className="text-3xl md:text-4xl font-bold text-white mb-4 translate-y-4 group-hover:translate-y-0 transition-transform duration-500">{service.title}</h3>
                    <div className="max-h-0 opacity-0 group-hover:max-h-40 group-hover:opacity-100 transition-all duration-700 ease-in-out overflow-hidden">
                      <p className="text-gray-300 text-lg leading-relaxed border-l-2 border-[#FAD201] pl-4 mb-4">{service.description}</p>
                    </div>
                  </div>
                </div>
              </Link>
